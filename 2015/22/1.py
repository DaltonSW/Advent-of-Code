...
def play(boss: Boss, hero: Hero, spell: Spell, manaSpent: int = 0):
    ...
    # Spell for turn already passed in
    # - Execute spell action
    # - Apply any effects, add up cost, deal damage
    # If boss dead, cool
    # Else, boss attacks me
    # If I'm dead, not cool
    # Else, find available spells, recursively call with all choices
